...
namespace StockpileStackLimit
{
    public static class CodeParser
    {
        ...
        {
            _ = KeywordTypes.TryGetValue(str, out Type t);
            if (t == null)
            {
        ...
        public static CodeInstruction Parse(string str)
        {
            ...
            else
            {
                ...
                switch (opcode.OperandType)
                {
                    case OperandType.InlineMethod:
                        ...
                        else
                        {
                            ...
                            obj = opcode == OpCodes.Newobj ? AccessTools.Constructor(type, args) : (object)AccessTools.Method(type, method, args);
                        }
                        break;
                ...
                return obj == null ? throw new Exception("Unknown OperandType or Wrong operand") : new CodeInstruction(opcode, obj);
            }
        }
        ...
        public static bool IsMatchWith(this CodeInstruction CodeWithMatchOption, CodeInstruction instr)
        {
            ...
            result &= (AnyOprand == CodeWithMatchOption.operand) || (CodeWithMatchOption.operand != null ? CodeWithMatchOption.operand.Equals(instr.operand) : null == instr.operand);
            return result;
        }
    }
    ...
    {
        readonly List<CodeInstruction> search;
    ...
    {
        readonly List<CodeInstruction> list;
    ...
    {
        readonly List<ITranspiler> transpilers;
        readonly TranspilerDelegate GetTranspiler;
